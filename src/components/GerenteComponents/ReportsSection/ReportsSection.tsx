          ...
          <div className="report-card-content">
            <div className="compliance-stats">
              <div className="compliance-item compliance-ok">
                <div className="compliance-value">{checklistCompliance.ok}</div>
              ...
              <div className="priority-item priority-high">
                <div className="priority-bar-container">
                  <div
                    ...
                    style={{
                      width: `${
                        (priorityDistribution.high / filteredTasks.length) * 100
                      }%`,
                    }}
                  />
                </div>
              ...
              <div className="priority-item priority-low">
                <div className="priority-bar-container">
                  <div
                    ...
                    style={{
                      width: `${
                        (priorityDistribution.low / filteredTasks.length) * 100
                      }%`,
                    }}
                  />
                </div>
